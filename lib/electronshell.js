...
exports.waitForConfirmingEmail = waitForConfirmingEmail; //3/4/23 by DW
...
function waitForConfirmingEmail () { //3/4/23 by DW
...
function init (options, callback) {
	...
	appOptions = options;
	var flHandleTabs = !getBoolean (appOptions.flDontHandleTabs); //5/24/21 by DW
	getPrefs (function () {
		if (flHandleTabs) {
			cleanPrefsAtStartup ();
			}
