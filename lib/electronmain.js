var myProductName = "electronLand", myVersion = "0.4.27";  
...
function sendIpcToBrowser (name, value) { //8/5/17 by DW
	console.log ("sendIpcToBrowser: name == " + name);
	if (bullMancuso !== undefined) {
		console.log ("sendIpcToBrowser: bullMancuso !== undefined");
...
function electronOpenHomePage (queryString) {
	...
	if (config.flOpenDevToolsAtStart) { 
		console.log ("electronOpenHomePage: About to call mainWindow.webContents.openDevTools.");
